...
using BaseTemplate.Application.Common.RequestHandler.Behaviors;
...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddRequestHandlersWithPipeline(this IServiceCollection services, Assembly assembly)
    {
        // Register pipeline behaviors
        services.AddScoped<IMediatorBehavior, NullValidationBehavior>();
        services.AddScoped<IMediatorBehavior, RequestValidationBehavior>();
        services.AddScoped<IMediatorBehavior, AuthorizationBehavior>();
        services.AddScoped<IMediatorBehavior, HandlerExecutionBehavior>();

        // Register pipeline mediator
        services.AddScoped<IMediatorPipeline, MediatorPipeline>();
